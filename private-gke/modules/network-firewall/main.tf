...
resource "google_compute_firewall" "private_allow_all_network_inbound" {
  ...
  source_ranges = [
    ...
    data.google_compute_subnetwork.subnetwork.secondary_ip_range[0].ip_cidr_range,
    data.google_compute_subnetwork.subnetwork.secondary_ip_range[1].ip_cidr_range,
