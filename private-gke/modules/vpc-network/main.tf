...
resource "google_compute_subnetwork" "vpc_subnetwork" {
  ...
  secondary_ip_range {
    range_name = var.subnetwork_secondary_range_name
    # ip_cidr_range = cidrsubnet(
    #   var.secondary_cidr_block,
    #   var.secondary_cidr_subnetwork_width_delta,
    #   0
    # )
    ip_cidr_range = var.secondary_cidr_block
  }

  secondary_ip_range {
    range_name = var.services_secondary_range_name
    # ip_cidr_range = var.services_secondary_cidr_block != null ? var.services_secondary_cidr_block : cidrsubnet(
    #   var.secondary_cidr_block,
    #   var.secondary_cidr_subnetwork_width_delta,
    #   1 * (2 + var.secondary_cidr_subnetwork_spacing)
    # )
    ip_cidr_range = var.services_secondary_cidr_block
...
resource "google_compute_router" "vpc_router" {
  name = "${var.subnetwork_name}-router"
...
module "network_firewall" {
  ...
  name_prefix = var.subnetwork_name
